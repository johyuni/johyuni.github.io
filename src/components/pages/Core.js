          ...
          <ul className="list">
            <li className="list__item txt">
              ...
              <p className="txt__body2">
                밝고 쾌활한 커뮤니케이션으로 팀원들과 조화를 이루며 긍정적인
                시너지를 만들어갑니다. 단순한 협업을 넘어 서로 돕고 배려하며
                팀워크의 가치를 실현할 수 있는 분위기를 만드는 데 기여하고자
                합니다. 더 나은 결과를 위해 함께 고민하고 성장하기를 희망합니다.
              </p>
            ...
            <li className="list__item txt">
              ...
              <p className="txt__body2">
                ...
                등 다양한 웹 개발 도구의 대한 경험을 토대로 기술의 흐름에
                얽매이지 않고 어떤 환경에서도 유연하게 대응하겠습니다. 견고하고
                효율적인 코드, 감각적인 UI를 추구합니다. 그간의 경험과 감각을
                살려 사용자에게 더 친숙한 인터페이스를 그리겠습니다.
              </p>
              <span className="txt__body3">
                &#35;감각적인 &#35;효율적인 &#35;섬세한
              </span>
